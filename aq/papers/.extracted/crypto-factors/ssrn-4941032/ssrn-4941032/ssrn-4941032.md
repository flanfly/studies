...
<span id="page-10-0"></span>CryptoSent<sup>t</sup> =0.4095 × Crypto Indext−<sup>1</sup> + 0.2701 × Google T rend<sup>t</sup> + 0.3759 × #Tweett−<sup>1</sup> + 0.3678 × V olatility<sup>t</sup> + 0.3882 × V olumet−<sup>1</sup> + 0.3840 × #W allet<sup>t</sup> + 0.3451 × Blockchain T ranscationst−<sup>1</sup> + 0.2554 × #ICO<sup>t</sup> , (1)
